...
- Skills 目录: ~/${configDirName}/agent-workspaces/${ctx.workspaceSlug}/skills/（Proma 工作区级 Skill 主目录；支持原生 Agent Skills 的 runtime 也可能显式加载 ~/.agents/skills/ 等全局目录。若某个 Skill 在当前会话不可见，再导入或移动到工作区 skills/ 目录）
